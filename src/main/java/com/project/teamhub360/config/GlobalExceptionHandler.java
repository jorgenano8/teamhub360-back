...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, List<String>>> handleSQLErrors(DataIntegrityViolationException ex) {
        List<String> errors = Collections.singletonList(ex.getMostSpecificCause().getMessage());
